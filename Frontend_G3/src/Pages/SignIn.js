...
export default function SignIn({ onLogin }) {
    ...
    const [isTxl, SetTxl] = useState(`${styles["is-txl"]}`);
    const [isZ200, SetZ200] = useState(`${styles["is-z200"]}`);
    const [isGx, SetGx] = useState("");
    ...
    const handleRegister = async e => {
        ...
        await registerUser({
            ...
            .then(() => window.alert('Đăng ký thành công !!!'), () => window.alert('Đăng ký thất bại, vui lòng nhập email khác hoặc thử lại sau'))
    }

    function SwitchHandler() {
        isHidden === `${styles["is-hidden"]}` ? SetHidden("") : SetHidden(`${styles["is-hidden"]}`);
        isNotHidden === "" ? SetNotHidden(`${styles["is-hidden"]}`) : SetNotHidden("");
        isTxr === `${styles["is-txr"]}` ? SetTxr("") : SetTxr(`${styles["is-txr"]}`);
        isTxl === `${styles["is-txl"]}` ? SetTxl("") : SetTxl(`${styles["is-txl"]}`);
        isZ200 === `${styles["is-z200"]}` ? SetZ200("") : SetZ200(`${styles["is-z200"]}`);
        SetGx(`${styles["is-gx"]}`)
        setTimeout(() => SetGx(""), 1500)
    }

    return <>
        <div className={styles["body"]} style={{
            backgroundImage: "url(" + "https://wallpaperforu.com/wp-content/uploads/2020/10/food-wallpaper-20100313212461920x1200.jpg" + ")",
            ...
            <div className={`${styles["main"]} ${styles["opacity"]}`}>
                <div className={`${styles["container"]} ${styles["a-container"]} ${isTxl}`} id={styles["a-container"]}>
                    <form className={styles["form"]} id={styles["a-form"]} onSubmit={handleRegister}>
                        <h2 className={styles["form_title title"]}>Đăng ký tài khoản</h2>
                        <div className={styles["form__icons"]}>
                            <img className={styles["form__icon"]}
                        ...
                        <span className={styles["form__span"]}>Nhập địa chỉ mail của bạn</span>
                        <input className={styles["form__input"]} type="text" placeholder="Tên"
                ...
                <div className={`${styles["container"]} ${styles["b-container"]} ${isTxl} ${isZ200}`}
                    id={styles["b-container"]}>
                    <form className={styles["form"]} id={styles["b-form"]} onSubmit={handleLogin}>
                        <h2 className={styles["form_title title"]}>Đăng nhập Website</h2>
                        <div className={styles["form__icons"]}>
                            <img className={styles["form__icon"]}
                                src="data:image/svg+xml;base64,"
                                alt="" />
                        ...
                        <span className={styles["form__span"]}>Sử dụng email của bạn</span>
                        <input className={styles["form__input"]} type="text" placeholder="Email" name="email"
                            onChange={e => setEmail(e.target.value)} required />
                        <input className={styles["form__input"]} type="password" placeholder="Mật khẩu" name='password'
                            onChange={e => setPassword(e.target.value)} required />
                        <a className={styles["form__link"]}>Quên mật khẩu</a>
                        <button className={`${styles["form__button"]} ${styles["button"]} ${styles["button"]}`}
                            type="submit">Đăng nhập
                        </button>
                    </form>
                </div>
                <div className={`${styles["switch"]} ${isTxr} ${isGx}`} id={styles["switch-cnt"]}>
                    <div className={`${styles["switch__circle"]} ${isTxr}`} />
                    <div className={`${styles["switch__circle"]} ${styles["switch__circle--t"]} ${isTxr}`} />
                    <div className={`${styles["switch__container"]} ${isHidden}`} id={styles["switch-c1"]}>
                    ...
                    <div className={`${styles["switch__container"]} ${isNotHidden}`} id={styles["switch-c2"]}>
                        <h2 className={`${styles["switch__title"]} ${styles["title"]}`}>Chào Mừng Bạn !</h2>
                        <p className={`${styles["switch__description"]} ${styles["description"]}`}>Đăng ký tài khoản của bạn</p>
                        <button className={`${styles["switch__button"]} ${styles["button"]} ${styles["switch-btn"]}`}
                            onClick={SwitchHandler}>Đăng ký
                        </button>
                    </div>
                </div>
            </div>
